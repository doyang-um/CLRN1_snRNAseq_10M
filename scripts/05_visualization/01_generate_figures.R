...
# ============================================
# Panel A: Violin plots - HSP90 family split by condition
# ============================================

fig_hsp90_vln <- VlnPlot(retina, features = hsp90_genes, group.by = "cell_type",
                         split.by = "condition", pt.size = 0, ncol = 3,
                         cols = c("WT" = "#4DAF4A", "CLRN1_KO" = "#E41A1C")) &
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
        plot.title = element_text(face = "bold", size = 11))

fig_hsp90_vln
ggsave("Figures/Fig_HSP90_ViolinPlots.pdf", fig_hsp90_vln, width = 14, height = 5)
ggsave("Figures/Fig_HSP90_ViolinPlots.png", fig_hsp90_vln, width = 14, height = 5, dpi = 300)

# ============================================
# Panel B: Dot plot - all chaperones by cell type and condition
# ============================================

fig_chaperone_dot <- DotPlot(retina, features = chaperone_genes, group.by = "cell_type",
                             split.by = "condition", cols = c("#4DAF4A", "#E41A1C")) +
  RotatedAxis() +
  ggtitle("Chaperone Expression: WT vs KO") +
  theme(plot.title = element_text(face = "bold", size = 12))

fig_chaperone_dot
ggsave("Figures/Fig_Chaperone_DotPlot.pdf", fig_chaperone_dot, width = 12, height = 6)
ggsave("Figures/Fig_Chaperone_DotPlot.png", fig_chaperone_dot, width = 12, height = 6, dpi = 300)
...
# ============================================
# Panel D: Feature plots for HSP90AB1 - WT vs KO
# ============================================

fig_hsp90ab1_feature <- FeaturePlot(retina, features = "HSP90AB1", split.by = "condition",
                                    pt.size = 0.5, order = TRUE) &
  scale_color_gradientn(colors = c("grey90", "orange", "red", "darkred")) &
  theme(plot.title = element_text(face = "bold", size = 12))

fig_hsp90ab1_feature
ggsave("Figures/Fig_HSP90AB1_FeaturePlot.pdf", fig_hsp90ab1_feature, width = 10, height = 4)
ggsave("Figures/Fig_HSP90AB1_FeaturePlot.png", fig_hsp90ab1_feature, width = 10, height = 4, dpi = 300)

# ============================================
# Combined Figure - HSP90 Resilience
# ============================================

fig_resilience <- (fig_hsp90ab1_feature) / (fig_heatmap) / (fig_hsp90_vln)
ggsave("Figures/Figure_HSP90_Resilience_Combined.pdf", fig_resilience, width = 14, height = 14)
ggsave("Figures/Figure_HSP90_Resilience_Combined.png", fig_resilience, width = 14, height = 14, dpi = 300)
